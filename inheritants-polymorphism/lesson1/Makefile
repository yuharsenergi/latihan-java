#To use this makefile to compile your java programs:
#    create a file named 'makefile' in your project directory with the same content as this example starting from "makefile begins".
